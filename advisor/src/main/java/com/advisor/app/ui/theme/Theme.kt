 ...
 * app inside it. Naming [AppId.ADVISOR] is the whole of this file's job: the sandbox answers with the
 ...
 */
@Composable
fun AdvisorTheme(content: @Composable () -> Unit) {
    SuiteTheme(appId = AppId.ADVISOR, content = content)
}

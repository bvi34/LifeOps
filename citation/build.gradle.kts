plugins {
    // Citation is now a *library* consumed by the Operations Sandbox container app (:sandbox).
...
// (:sandbox) alongside LifeOps; the two still talk only over the sync seam in :core. Everything
...
android {
    ...
    defaultConfig {
        minSdk = 26
        // Code shrinking is the consuming app's (:sandbox) responsibility.
    }

 ...
 * app inside it. Naming [AppId.CITATION] is the whole of this file's job: the sandbox answers with the
 ...
 */
@Composable
fun CitationTheme(content: @Composable () -> Unit) {
    SuiteTheme(appId = AppId.CITATION, content = content)
}

...
fun BookEntity.toModel() = Book(id, title, author, BookStatus.from(status), createdAt, completedAt, sourceType, category)
fun Book.toEntity() = BookEntity(id, title, author, status.name, createdAt, completedAt, sourceType, category)

 ...
 * Logistics database, the [LifeOpsCatalog] bridge, and the [PantryRepository]. Everything is lazy,
 * so bringing Logistics up is essentially free until its screen is opened.
 */

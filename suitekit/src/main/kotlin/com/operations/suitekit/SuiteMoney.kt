 ...
 *
 * Everything monetary in the suite is a `Long` of cents. A balance in floating point is a balance
 * that drifts, and the apps' whole claim is that these numbers are the ones on your statement.
 *
